...
@interface WYALowLeverTestScoresCell ()
...
@implementation WYALowLeverTestScoresCell
...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier{
    ...
    if (self) {
        ...
        self.peopleLabel.textColor = [UIColor WYAJHBlackTextColor];
...
-(void)setModel:(WYAMineTestScoresListModel *)model{
    if (model) {
        ...
        self.peopleLabel.text = [NSString stringWithFormat:@"下级人数：%@",checkString(model.number)];
    }
}
